"""Physical constants, periodic table data, and unit conversion factors.

This module is a leaf dependency with no imports from other backend modules.
"""
...
# ---------------------------------------------------------------------------
# Average atomic masses (amu), indexed by atomic number
# ---------------------------------------------------------------------------
...
def atomic_mass_amu(atomic_number: int) -> float:
    """Return the average atomic mass in amu for the given atomic number."""
...
def atom_symbol(atomic_number: int) -> str:
    """Return the element symbol for the given atomic number, or 'X' if unknown."""
    index = int(atomic_number)
